            ...
            if (dragObject != null && !String.IsNullOrEmpty(dragObject.Xaml))
            {
                ...
                if (content != null)
                {
                    ...
                    if (dragObject.DesiredSize.HasValue)
                    {
                        ...
                        WidgetPanel.SetLeft(newItem, Math.Max(0, position.X - newItem.Width / 2));
                        WidgetPanel.SetTop(newItem, Math.Max(0, position.Y - newItem.Height / 2));
                    }
                    else
                    {
                        WidgetPanel.SetLeft(newItem, Math.Max(0, position.X));
                        WidgetPanel.SetTop(newItem, Math.Max(0, position.Y));
                    }
